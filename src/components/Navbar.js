...
const Navbar = () => {
  ...
  return (
    <div className='fixed w-full  z-30 '>
      <div className=' px-4 py-2 border-b-4 border-rick_blue xl:py-4 flex items-center justify-between  xl:px-8 bg-zinc-800 '>
        <div>
          <h2 className='font-rickmorty text-4xl text-rick_lightGreen'>
            Rick and Morty
          </h2>
        </div>
